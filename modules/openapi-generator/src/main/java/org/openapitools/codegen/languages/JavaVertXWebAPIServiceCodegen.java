...
public class JavaVertXWebAPIServiceCodegen extends AbstractJavaCodegen {
     ...
     */
    public JavaVertXWebAPIServiceCodegen() {
        super();

        // set the output folder here
        outputFolder = "generated-code" + File.separator + "javaVertXWebAPIService";
    ...
    public String getName() {
        return "java-vertx-webapiservice";
    }
